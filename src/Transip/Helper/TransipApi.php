...
namespace Upmind\ProvisionProviders\DomainNames\Transip\Helper;
...
use Upmind\ProvisionProviders\DomainNames\Transip\Data\TransipConfiguration;
use Upmind\ProvisionProviders\DomainNames\Helper\Utils;
use Upmind\ProvisionProviders\DomainNames\Transip\Helper\TransipApi;

/**
 * Class TransipCommand
 *
 * @package Upmind\ProvisionProviders\DomainNames\Transip\Helper
 */
class TransipApi
{
    /**
    ...
    protected TransipConfiguration $configuration;

    protected SystemInfo $systemInfo;

    public function __construct(Client $client, TransipConfiguration $configuration, SystemInfo $systemInfo)
    {
        $this->client = $client;
